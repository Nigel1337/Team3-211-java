...
public class StudentsController implements Initializable {
    ...
    private ArrayList<StudentsModel> students = new ArrayList<StudentsModel>(){
        {
            add(new StudentsModel(1,"Adnan", "Islam"));
            add(new StudentsModel(2, "Ebu", "Kara"));
            add(new StudentsModel(3,"Johnson")); // polymorphic call - constructor overloading
            add(new StudentsModel(4,"Archer", "Malik"));
        }
    };
